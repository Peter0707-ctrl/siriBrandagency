...
import { X, CheckCircle2, ArrowRight, ChevronLeft, ChevronRight, Play, Pause, ExternalLink } from 'lucide-react';
      ...
      <div className="relative w-full max-w-4xl bg-[#0b0f19] border border-slate-700/60 rounded-2xl shadow-2xl overflow-hidden z-10 my-auto">
        ...
        <div className="p-6 md:p-8 max-h-[80vh] overflow-y-auto space-y-8">
          ...
          <div className="relative rounded-xl overflow-hidden border border-slate-800 bg-slate-950 aspect-video md:aspect-[21/9] group select-none">
            ...
            {/* Top Right Controls: Instagram Reel link & Play/Pause Toggle */}
            <div className="absolute top-3 right-3 z-20 flex items-center gap-2">
              {project.videoUrl && (
                <a
                  ...
                  className="px-2.5 py-1.5 rounded-lg bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white text-[11px] font-semibold flex items-center gap-1.5 shadow-lg shadow-pink-600/30 transition-all hover:scale-105"
          ...
          {/* Official Video / Reel Link if available */}
          {project.videoUrl && (
            <div className="p-4 sm:p-5 rounded-xl bg-gradient-to-r from-pink-950/40 via-purple-950/30 to-slate-900/60 border border-pink-500/30 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-11 h-11 rounded-full bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 flex items-center justify-center shrink-0 shadow-lg shadow-pink-500/20">
                  <Play className="w-5 h-5 text-white fill-white ml-0.5" />
                </div>
                <div>
                  <h4 className="text-sm font-bold text-white flex items-center gap-2">
                    Official Video Reel Documentation
                  ...
                  <p className="text-xs text-slate-300 mt-0.5">
                    Tazama video na matukio rasmi ya uhalisia moja kwa moja kwenye Instagram.
                  </p>
                </div>
              </div>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full sm:w-auto shrink-0 inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white text-xs font-semibold shadow-md shadow-pink-600/30 transition-all hover:scale-105"
              >
