...
export const BrandPhilosophySection: React.FC = () => {
  return (
    <section id="philosophy" className="py-14 sm:py-16 bg-[#040814] border-b border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 space-y-2">
          ...
          <p className="text-[11px] font-mono font-bold text-blue-400 uppercase tracking-widest">
            #WeForecastRealities
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-2.5 sm:gap-3">
          {philosophyPillars.map((pillar, i) => (
            <div
              key={pillar.word}
              className="agency-card p-3 text-center flex flex-col justify-between rounded-xl"
            >
              <div className="space-y-1.5">
                <div className="w-8 h-8 rounded-lg bg-slate-900 border border-slate-800 flex items-center justify-center mx-auto mb-1.5">
                  {pillar.icon}
                </div>
              ...
              <p className="text-[10px] text-slate-400 leading-snug mt-1.5 pt-1.5 border-t border-slate-800/80">
                {pillar.desc}
              </p>
            </div>
          ))}
